...
namespace Corona_M_system.Controllers
{
    public class VaccinationsController : Controller
    {
        ...
        public VaccinationsController(Corona_M_systemContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Vaccination != null ? 
                          ...
                          Problem("Entity set 'Corona_M_systemContext.Vaccination'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Eid,manufacturer")] Vaccination vaccination)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Eid,manufacturer")] Vaccination vaccination)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Corona_M_systemContext.Vaccination'  is null.");
            }
            var vaccination = await _context.Vaccination.FindAsync(id);
            if (vaccination != null)
            {
